...
import { Code, Container, Tabs, Text } from "@EArpaci/rn-ui-kit";
      ...
      <ScrollView contentContainerStyle={{ padding: 20, gap: 20 }}>
        ...
        <Tabs defaultValue="npm">
          ...
          <Tabs.Content value="npm">
            <Code
              ...
              code="npm install @EArpaci/rn-ui-kit"
            />
          </Tabs.Content>
          <Tabs.Content value="yarn">
            <Code
              textColor="#000"
              backgroundColor="#f5f5f5"
              code="yarn add @EArpaci/rn-ui-kit"
            />
          </Tabs.Content>
          <Tabs.Content value="bun">
            <Code
              textColor="#000"
              backgroundColor="#f5f5f5"
              code="bun add @EArpaci/rn-ui-kit"
            />
          </Tabs.Content>
          <Tabs.Content value="pnpm">
            <Code
              textColor="#000"
              backgroundColor="#f5f5f5"
              code="pnpm install @EArpaci/rn-ui-kit"
            />
          </Tabs.Content>
          <Tabs.Content value="expo">
            <Code
              textColor="#000"
              backgroundColor="#f5f5f5"
              code="npx expo install @EArpaci/rn-ui-kit"
            />
          </Tabs.Content>
        </Tabs>
        ...
        <View style={{ gap: 20 }}>
          ...
          <Text variant="bodyLarge">
            ...
            @EArpaci/rn-ui-kit(if you are using toaster). If you have a vanilla
            React Native project, it's a good idea to add it in the component
            which is passed to AppRegistry.registerComponent. This will usually
            be in the index.js file. If you have an Expo project, you can do
            this inside the exported component in the App.js file.
          </Text>
          <Code
            textColor="#000"
            backgroundColor="#f5f5f5"
